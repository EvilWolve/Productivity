...
namespace framework.editor.codetemplates
{
    internal sealed class ScriptKeywordProcessor : UnityEditor.AssetModificationProcessor
    {
        ...
        public static void OnWillCreateAsset(string path)
        {
            ...
            string codeKeysPath = Path.GetFullPath (CodeTemplates.CODE_TEMPLATES_ROOT + "Settings/TemplateKeys.txt");
        ...
        {
            string contentRaw = k.content;
            contentRaw = contentRaw.Replace ("[Time]", System.DateTime.Now.ToString ("dd/MM/yyyy"));
            contentRaw = contentRaw.Replace ("[TimeExact]", System.DateTime.Now.ToString ("dd/MM/yyyy HH:mm"));
